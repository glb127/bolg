...
Halftone.defaults = {
  // dot size
  dotSize: 1/40, //点的个数，默认1/40，底数越大画面越精细也越卡
  dotSizeThreshold: 0.05, //点的疏密程度，默认0.05，越大越疏，1就看不到了
  initVelocity: 0.02, //点初始化速度，默认0.02，越大速度越快
  oscPeriod: 3, //点自动频率，默认3，越大频率越小
  oscAmplitude: 0.2, //，默认0.2，越大越
  // layout and color
  isAdditive: false, //，默认false，true时背景图片显示彩色
  isRadial: false, //，默认false，true粒子汇集到中心
  channels: [ 'red', 'green', 'blue' ], //颜色通道，默认[ 'red', 'green', 'blue' ]，可填入lum
  isChannelLens: true, //滤镜，默认true，没差
  // behavoir
  friction: 0.06, //点运动来回距离，默认0.06，越大越越不动
  hoverDiameter: 0.3, //鼠标吸引半径，默认0.3，越大吸引面积越大，大时会有很神奇效果
  hoverForce: -0.02, //吸引力，默认-0.02，绝对值越大力越大，正为推力，负数为吸力
  activeDiameter: 0.6, //运动时反向半径，默认0.6，越大退离面积越大
  activeForce: 0.01 //，默认0.01，越大越绝对值越大力越大
};
